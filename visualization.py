...
def draw_body_joints_2d(img_orig, pts2d, bones=None, draw_indices=None):
	...
	for i in range(len(pts2d)):
		if not math.isnan(pts2d[i][0])  and (not math.isnan(pts2d[i][1])):
...
if __name__ == '__main__':
	...
	keypoints_npz_path = 'predictions/Lumotionpred_002.npz'
	...
	img_generator = read_video('videos/Lu_wave_squat.mp4')  # or get them from a video

	#Visualize the keypoints:
	visualize_keypoints(img_generator, keypoints, mp4_output_path='videos/Lumotion_wave_squat_pred_001.mp4')
